...
import { Loader2, AlertCircle, Mail, KeyRound, ShoppingBag } from 'lucide-react';
...
const BuyerLoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
        ...
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            <h1 className="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 text-transparent bg-clip-text">
              {vendorStore?.name || 'Store'}
            </h1>
            <p className="mt-2 text-gray-600 dark:text-gray-400">Customer Login</p>
          </div>
          ...
          <Card className="border-none shadow-lg">
            <CardHeader>
              ...
              <CardDescription className="text-center">
                Log in to your customer account with one-time code
              </CardDescription>
            </CardHeader>
      ...
      {/* Right panel with store info (only visible on large screens) */}
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-indigo-600 to-purple-700 items-center justify-center p-12">
        <div className="max-w-md text-white">
          <h2 className="text-3xl font-bold mb-6">Shop with Ease and Convenience</h2>
          <p className="text-lg mb-8 text-indigo-100">
            Log in to your account to enjoy personalized shopping experience, 
            track your orders, manage your wishlist, and access exclusive deals.
          </p>
          <div className="space-y-4">
            ...
            <div className="flex items-start">
              ...
              <p>Get exclusive access to deals and promotions</p>
            </div>
          </div>
        </div>
      </div>
